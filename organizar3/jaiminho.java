	...
	public static void main(String[] args) {
		...
		while (QT > 0){
			...
			for (int i=0 ; i<N ; i++){
				...
				// ----- HORA E MINUTO ENTRADA NÃO PODE SER MAIOR QUE HORA E MINUTO SAÍDA -----
				//A1:B1 ≤ A2:B2 && C1:D1 ≤ C2:D2
//				if (HEM<=HSM && HET<=HST && HSM<=HET){
				if (HEM>HSM || HET>HST || HSM>HET)
					break;
				else if (HEM==HSM){
					if (MEM>MSM)
